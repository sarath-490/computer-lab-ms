...
import { 
  ...
  Linkedin, Youtube, FlaskConical, Atom, 
  TestTube2, Laptop2, ChevronLeft, ChevronRight
} from 'lucide-react';
...
const labEquipment = [
  {
    ...
    title: 'Advanced Computer Analyzer',
...
export default function HomePage() {
  return (
    <div className="relative bg-white overflow-hidden">
      {/* Hero section with Vignan University background */}
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="pt-6"
                  >
                    <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-md hover:shadow-lg transition-shadow duration-200">
                      <div className="-mt-6">
                        <div>
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                {labEquipment.map((equipment, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.8, delay: index * 0.2 }}
                    whileHover={{ y: -5 }}
                    className="flex flex-col rounded-xl bg-white shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="hover:text-indigo-400 transition-colors duration-200" aria-label="Facebook">
                  ...
                  <a href="#" className="hover:text-indigo-400 transition-colors duration-200" aria-label="YouTube">
                ...
                <div className="mt-6">
                  ...
                  <form className="flex">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-indigo-600 rounded-r-md hover:bg-indigo-700 transition-colors duration-200"
                    >
                      Subscribe
                    </button>
                  </form>
